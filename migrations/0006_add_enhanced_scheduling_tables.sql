-- Create the camp_sessions table for enhanced scheduling
...
-- Create the recurrence_patterns table for storing recurrence information
...
CREATE INDEX IF NOT EXISTS camp_sessions_recurrence_group_id_idx ON camp_sessions(recurrence_group_id);
