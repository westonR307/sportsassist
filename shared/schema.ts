...
export const insertUserSchema = z.object({
  ...
  // Username is optional on the client side because it will be generated by the server
  // if not provided. However, the server ensures the database constraint is satisfied
  // by generating a username with a consistent format.
